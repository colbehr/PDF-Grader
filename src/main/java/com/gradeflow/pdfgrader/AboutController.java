...
public class AboutController {
    ...
    public void DaneGithub() throws URISyntaxException, IOException {
        app.getHostServices().showDocument(new URI("https://github.com/danebuckley").toString());
    }
    public void DaneWebsite() throws URISyntaxException, IOException {
        app.getHostServices().showDocument(new URI("https://www.google.com").toString());
    }

    public void ShadrachGithub() throws URISyntaxException, IOException {
        app.getHostServices().showDocument(new URI("https://github.com/roundys").toString());
    }
